...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return (18*r.meanSpeed() + 1.79) * (r.Weight / MInKm) * r.Duration.Hours() * 60
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	heightM := float64(w.Height) / CmInM
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(w.meanSpeed()*KmHInMsec, 2)/heightM)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
